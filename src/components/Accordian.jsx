        ...
        <div className="w-6xl ml-34 mt-4 flex flex-col space-y-3">
          ...
          <div className="rounded-md bg-gray-700">
            ...
            {openIndex===0 && (
              <p className="border-t border-b-gray-200 ml-4 mr-4 opacity-50 p-4 text-md">
                HyperFlix is a streaming service that offers a wide variety of
          ...
          <div className="rounded-md bg-gray-700">
            <div onClick={()=> handleClick(1)} className="flex items-center justify-between cursor-pointer hover:bg-gray-600 p-4 hover:rounded-md">
              <h3>
              How much does HyperFlix cost?
            </h3>
            <IoIosArrowDown className="mr-5"/>
            </div>
            {openIndex===1 && (
              <p className="border-t border-b-gray-200 ml-4 mr-4 opacity-50 p-4 text-md">
                Watch HyperFlix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from ₹1 to ₹10/month.
              </p>
            )}
          </div>
          ...
          <div className="rounded-md bg-gray-700">
            ...
            {openIndex===2 && (
              <p className="border-t border-b-gray-200 ml-4 mr-4 opacity-50 p-4 text-md">
                Watch anywhere, anytime. Sign in with your HyperFlix account to watch instantly on the web at hyperflix.com from your personal computer or on any internet-connected device that offers the HyperFlix app, including smart TVs, smartphones, tablets, streaming media players and game consoles. You can also download your favourite shows with the iOS or Android app. Use downloads to watch while you're on the go and without an internet connection. Take HyperFlix with you anywhere.
              </p>
            )}
          </div>
          ...
          <div className="rounded-md bg-gray-700">
            ...
            {openIndex===3 && (
              <p className="border-t border-b-gray-200 ml-4 mr-4 opacity-50 p-4 text-md">
               HyperFlix is flexible. You can easily cancel your account online in two clicks. There are no cancellation fees – start or stop your account anytime.
              </p>
            )}
          </div>
          ...
          <div className="rounded-md bg-gray-700">
            <div onClick={()=> handleClick(4)} className="flex items-center justify-between cursor-pointer hover:bg-gray-600 p-4 hover:rounded-md">
              <h3>
              Where can i watch on HyperFlix?
            </h3>
           <IoIosArrowDown className="mr-5"/>
            </div>
            {openIndex===4 && (
              <p className="border-t border-b-gray-200 ml-4 mr-4 opacity-50 p-4 text-md">
                HyperFlix has an extensive library of feature films, documentaries, shows, anime, award-winning HyperFlix originals, and more. Watch as much as you want, anytime you want.
              </p>
            )}
          </div>
          ...
          <div className="rounded-md bg-gray-700">
            <div onClick={()=> handleClick(5)} className="flex items-center justify-between cursor-pointer hover:bg-gray-600 p-4 hover:rounded-md">
              <h3>
              Is HyperFlix good for kids?
            </h3>
             <IoIosArrowDown className="mr-5"/>
            </div>
            {openIndex===5 && (
              <p className="border-t border-b-gray-200 ml-4 mr-4 opacity-50 p-4 text-md">
                The HyperFlix Kids experience is included in your membership to give parents control while kids enjoy family-friendly TV shows and films in their own space. Kids profiles come with PIN-protected parental controls that let you restrict the maturity rating of content kids can watch and block specific titles you don’t want kids to see.
              </p>
            )}
          </div>
