        ...
        <div className="max-w-7xl mx-auto space-y-2 text-center">
          ...
          <div className="relative inline-block mb-10">
            ...
            <select
              ...
              value={language}
              id="languageSelect"
              className="appearance-none border border-gray-800 rounded-sm pl-4 pr-8 py-2 text-sm bg-black text-white focus:outline-none outline-none cursor-pointer hover:border-amber-600 active:border-amber-600"
            >
              <option className="cursor-pointer" value={"en"}>
                English
              </option>
              <option className="cursor-pointer" value={"telugu"}>
                Telugu
              </option>
              <option className="cursor-pointer" value={"hindi"}>
                Hindi
              </option>
            </select>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center sm:items-start gap-4 mb-12 h-28">
            ...
            <button
              className="bg-red-600 px-6 py-3 rounded-md text-white hover:bg-red-700 active:bg-red-700 transition-colors shadow-lg"
